...
require("classes.map.types")
require("classes.player.types")
require("classes.portrait.types")
require("classes.structure.types")

require("classes.player.player")
require("classes.structure.structure")
require("classes.map.map")
require("classes.portrait.portrait")
...
function love.load()
	...
	player = Player(
		...
		config.PLAYER_SPRITE_SCALE,
		config.PLAYER_COLLISION_WIDTH,
		config.PLAYER_COLLISION_HEIGHT
	)
